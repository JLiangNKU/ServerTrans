...
req_grp.add_argument('--prefix', default='../day2night_nocycle_instancenorm_recons1_dis1', type=str, help='prefix of this training')
req_grp.add_argument('--task', default='day2night', type=str, help='task to do')
req_grp.add_argument('--start_iter', default=8500, type=int, help='iterations to start training')
