...
class Generator(keras.Model):
    ...
    def __init__(self):
        ...
        self.conv_first = keras.layers.Conv2D(16, kernel_size=3, strides=2,
                                            kernel_initializer=tf.random_normal_initializer(stddev=0.02))
        
        self.conv_second = keras.layers.Conv2D(64, kernel_size=3, strides=2,
                                            kernel_initializer=tf.random_normal_initializer(stddev=0.02))
        ...
        self.conv_second_last = keras.layers.Conv2DTranspose(16, kernel_size=3, strides=2,
                                            kernel_initializer=tf.random_normal_initializer(stddev=0.02))

        self.conv_last = keras.layers.Conv2DTranspose(3, kernel_size=3, strides=2,
                                            kernel_initializer=tf.random_normal_initializer(stddev=0.02))
    ...
    def call(self, inputs, training=True):
        ...
        height = x.get_shape()[1]+1  # if is_train else tf.shape(out)[0]
        width = x.get_shape()[2]+1  # if is_train else tf.shape(out)[1]
...
class Transform_high(keras.Model):
    ...
    def __init__(self):
        ...
        self.conv_first = keras.layers.Conv2D(64, kernel_size=3, strides=1,
                                            kernel_initializer=tf.random_normal_initializer(stddev=0.001), bias_initializer='ones')
