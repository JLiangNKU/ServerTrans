...
req_grp.add_argument('--prefix', default='../pair_level3_relu', type=str, help='prefix of this training')
...
def train(train_dataset, args, lsgan=True):
    ...
    for iteration in range(args.start_iter, args.max_iterations):
        ...
        with tf.GradientTape() as genA2B_tape, tf.GradientTape() as transA2B_tape:
            ...
            genA2B_loss = args.mse_lambda_low * mse_loss_low + args.mse_lambda_full * mse_loss_full + args.mse_lambda_high * mse_loss_high + args.tv_lambda * tv_loss + args.color_lambda * color_loss# 
