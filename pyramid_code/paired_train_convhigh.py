...
def train(train_dataset, args, lsgan=True):
    ...
    for iteration in range(args.start_iter, args.max_iterations):
        ...
        with tf.GradientTape() as genA2B_tape, tf.GradientTape() as transA2B_tape:
            ...
            highA2B_output_o = transA2B(highs_A, training=True)

            genA2B_output_full = merge_image(genA2B_output, highA2B_output_o)
            ...
            mse_loss_high = tf.reduce_mean(tf.square(highs_B[0] - highA2B_output_o[0]))
        ...
        if iteration % args.test_interval == 0:
            ...
            for i in range(args.test_size):
                ...
                generated_high = transA2B(highs_test, training=False)
