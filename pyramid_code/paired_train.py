...
req_grp.add_argument('--prefix', default='../enhance_pair_initialization', type=str, help='prefix of this training')
...
train_grp.add_argument('--mse_lambda_low', default=1, type=float, help='weight of the mse loss.')
train_grp.add_argument('--mse_lambda_high', default=5, type=float, help='weight of the mse loss.')
train_grp.add_argument('--mse_lambda_full', default=5, type=float, help='weight of the mse loss.')
